...
>>>>>>> 92d823f9512e06acf3b2229a0426abad57e72ae4
                ...
                <div class="flex items-center md:order-2">
                    ...
                    <!-- Dropdown -->
                    <div class=" z-50 hidden my-4 text-base list-none divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700"
                        id="language-dropdown-menu">
                        <ul class="pb-2 font-medium" role="none">
                            <li>
                                <a href="#"
                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1"
                    ...
                    <ul
                        class="flex flex-col font-medium px-4 md:p-0 mt-1  rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
