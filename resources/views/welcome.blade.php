                ...
                <div class="flex items-center">
                    ...
                    <div id="dropdown-project"
                        ...
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefault">
                            ...
                            <li>
                                <a href="#" class="block px-4 py-2 dark:hover:bg-gray-600 dark:hover:text-white">My
                                    Archievement</a>
                            </li>
                            <li>
                                <a href="#"
        ...
        <ol class="relative border-l border-gray-200 dark:border-gray-700">
            ...
            <li class="mb-10 ml-6">
                ...
                <p class="text-base font-normal text-gray-500 dark:text-gray-400">Empower your educational institution with
                    our cutting-edge school management system built on the robust Laravel framework.</p>
            </li>
            <a href="https://github.com/JRMHD/james_website.git" target="_blank"
            ...
            <li class="ml-6 mb-6">
                ...
                <p class="text-base font-normal text-gray-500 dark:text-gray-400">Effortlessly organize and consolidate
                    your scattered image files with our Python-powered project, 'Copy All Images into One Folder.'</p>
            </li>
            <a href="https://github.com/JRMHD/Python-Moving-images-from-Downloads-to-Image-Folder.git" target="_blank"
                class=" mb-6 ml-6 inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 border border-gray-200 rounded-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-200 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700"><svg
                    class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd"
                        d="M6 2a2 2 0 00-2 2v12a2 2 0 002 2h8a2 2 0 002-2V7.414A2 2 0 0015.414 6L12 2.586A2 2 0 0010.586 2H6zm5 6a1 1 0 10-2 0v3.586l-1.293-1.293a1 1 0 10-1.414 1.414l3 3a1 1 0 001.414 0l3-3a1 1 0 00-1.414-1.414L11 11.586V8z"
            ...
            <li class="ml-6 mt-10">
                ...
                <p class="text-base font-normal text-gray-500 dark:text-gray-400">Elevate your website's navigation with
                    ...
                    implementing a sleek and responsive navigation bar that seamlessly adapts to different screen sizes.</p>
            </li>
            <a href="https://github.com/JRMHD/Reagan.git" target="_blank"
            ...
            <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <a href="#"
                        ...
                        <div class="flex flex-col justify-between p-4 leading-normal">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Reagan Mukabana, CEO JRMHD Technologies</h5>
                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400"> "Working with JRMHD has been an absolute pleasure. Their expertise and commitment to delivering high-quality projects have surpassed our expectations. From the Coffee Project in Laravel to the School Management System and Copy All Images into One Folder Using Python, they have consistently demonstrated their proficiency in various technologies.

                                JRMHD's team of professionals truly understands our requirements and goes above and beyond to ensure our satisfaction. Their attention to detail, excellent communication, and ability to deliver projects on time have made them our go-to partner for all our development needs."</p>
                        </div>
                    </a>
                </div>
                <!-- Item 5 -->
