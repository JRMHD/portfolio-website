                    ...
                    <a href="#"
                        ...
                        <div class="flex flex-col justify-between p-4 leading-normal">
                            ...
                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Lorem, ipsum dolor sit amet
                                consectetur adipisicing elit. Quo, tempore! Neque molestiae fuga tempora dolorum laborum,
                                ipsum consequatur ab odio, at accusantium vitae repudiandae nam? Explicabo veritatis
                                incidunt at adipisci!</p>
                        </div>
                    </a>
                </div>
                <!-- Item 3 -->
                    ...
                    <a href="#"
                        ...
                        <div class="flex flex-col justify-between p-4 leading-normal">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Noteworthy
                                technology acquisitions 2021</h5>
                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Lorem ipsum dolor, sit amet
                                consectetur adipisicing elit. Repellendus error molestiae quae perferendis possimus quo
                                totam nam voluptatem amet, reiciendis sequi quibusdam nulla eius odio minima maxime incidunt
                                illo vitae!</p>
                        </div>
                    </a>
                </div>
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <a href="#"
                        ...
                        <div class="flex flex-col justify-between p-4 leading-normal">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Noteworthy
                                technology acquisitions 2021</h5>
                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">lorem 2 Lorem, ipsum dolor sit
                                amet consectetur adipisicing elit. Quaerat delectus eum asperiores debitis deleniti est
                                quae, aspernatur tempore vitae nemo tenetur iure corporis fugit pariatur ea labore quisquam?
                                Consequuntur, quae?</p>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="#"
                        ...
                        <div class="flex flex-col justify-between p-4 leading-normal">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Noteworthy
                                technology acquisitions 2021</h5>
                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Lorem ipsum, dolor sit amet
                                consectetur adipisicing elit. Animi, eligendi eos? Voluptatum voluptas ullam quidem numquam
                                accusamus tenetur veniam, nihil mollitia animi fugit fuga deserunt ducimus laudantium! Iure,
                                totam possimus!</p>
                        </div>
                    </a>
                </div>
